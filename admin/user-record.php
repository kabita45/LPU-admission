  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <img src="../images/apple-touch-icon.jpg" alt=" Logo" width="154" height="143"
          style="opacity: .8; margin: 0 0 0 21px;">
                        ...
                        <tbody>
                          ...
                          while ($row = $result->fetch_assoc()) {
                            ...
                            <tr class="gradeX">
                              ...
                              <td>
                                <div align="center">
                                  <?php echo $row['ssce_details']; ?>
                                </div>
                              </td>
                              <td>
                                <div align="center"><span class="controls"><img src="../<?php echo $row['ssce']; ?>"
                                      width="100" height="100" border="2" /></span></div>
                              </td>
                              <td>
